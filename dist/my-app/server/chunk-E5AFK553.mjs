...
var k = class o {
  ...
  static ɵcmp = s({
    ...
    template: function (i, m) {
      i & 1 &&
        (n(0, "main", 0)(1, "header", 1)(2, "div", 2)(3, "div", 3)(4, "a", 4),
        a(),
        n(5, "svg", 5),
        t(6, "use", 6),
        e()(),
...
var B = (o, l) => l.title,
  j = () => ({ title: "Explore the Docs", link: "https://angular.dev" }),
  R = () => ({
    title: "Learn with Tutorials",
    link: "https://angular.dev/tutorials",
  }),
  q = () => ({ title: "CLI Docs", link: "https://angular.dev/tools/cli" }),
  Y = () => ({
...
var P = class o {
  ...
  static ɵcmp = s({
    ...
    template: function (i, m) {
      i & 1 &&
        (n(0, "main", 0)(1, "div", 1)(2, "div", 2)(3, "div"),
        r(4, "Home"),
        e(),
        a(),
        n(5, "svg", 3)(6, "g", 4),
        t(7, "path", 5)(8, "path", 6),
        e(),
        n(9, "defs")(10, "radialGradient", 7),
        t(11, "stop", 8)(12, "stop", 9)(13, "stop", 10),
        e(),
        n(14, "linearGradient", 11),
        t(15, "stop", 12)(16, "stop", 13)(17, "stop", 14)(18, "stop", 15),
        e(),
        n(19, "clipPath", 16),
        t(20, "path", 17),
        e()()(),
        ...
        e(),
        n(23, "p"),
        r(24, "Congratulations! Your app is running. \u{1F389}"),
        e()(),
        t(25, "div", 18),
        n(26, "div", 19)(27, "div", 20),
        u(28, J, 5, 2, "a", 21, B),
        e(),
        n(30, "div", 22)(31, "a", 23),
        a(),
        ...
        i & 2 &&
          ...
          _("Hello, ", m.title, ""),
          g(6),
          f(b(6, $, c(1, j), c(2, R), c(3, q), c(4, Y), c(5, N))));
    },
    dependencies: [d],
    styles: [
      `[_nghost-%COMP%] {
...
var y = class o {
  ...
  static ɵcmp = s({
    ...
    template: function (i, m) {
      i & 1 &&
        (n(0, "main", 0)(1, "body", 1)(2, "main", 2)(3, "form"),
        t(4, "img", 3),
        n(5, "h1", 4),
        r(6, "Please sign in"),
        e(),
...
var K = (o, l) => l.title,
  Q = () => ({ title: "Explore the Docs", link: "https://angular.dev" }),
  W = () => ({
    title: "Learn with Tutorials",
    link: "https://angular.dev/tutorials",
  }),
  X = () => ({ title: "CLI Docs", link: "https://angular.dev/tools/cli" }),
  n1 = () => ({
    title: "Angular Language Service",
    link: "https://angular.dev/tools/language-service",
  }),
    ...
    template: function (i, m) {
      i & 1 &&
        ...
        i & 2 &&
          ...
          _("Hello, ", m.title, ""),
          g(6),
          f(b(6, t1, c(1, Q), c(2, W), c(3, X), c(4, n1), c(5, e1))));
    },
    dependencies: [d],
    styles: [
      `[_nghost-%COMP%] {
...
var o1 = (o, l) => l.title,
  l1 = () => ({ title: "Explore the Docs", link: "https://angular.dev" }),
  r1 = () => ({
    title: "Learn with Tutorials",
    link: "https://angular.dev/tutorials",
  }),
  a1 = () => ({ title: "CLI Docs", link: "https://angular.dev/tools/cli" }),
  c1 = () => ({
    title: "Angular Language Service",
    link: "https://angular.dev/tools/language-service",
  }),
    ...
    template: function (i, m) {
      i & 1 &&
        ...
        i & 2 &&
          ...
          _("Hello, ", m.title, ""),
          g(6),
          f(b(6, m1, c(1, l1), c(2, r1), c(3, a1), c(4, c1), c(5, p1))));
    },
    dependencies: [d],
    styles: [
      `[_nghost-%COMP%] {
...
var s1 = (o, l) => l.title,
  h1 = () => ({ title: "Explore the Docs", link: "https://angular.dev" }),
  d1 = () => ({
    title: "Learn with Tutorials",
    link: "https://angular.dev/tutorials",
  }),
  v1 = () => ({ title: "CLI Docs", link: "https://angular.dev/tools/cli" }),
  C1 = () => ({
    title: "Angular Language Service",
    link: "https://angular.dev/tools/language-service",
  }),
    ...
    template: function (i, m) {
      i & 1 &&
        ...
        i & 2 &&
          ...
          _("Hello, ", m.title, ""),
          g(6),
          f(b(6, f1, c(1, h1), c(2, d1), c(3, v1), c(4, C1), c(5, u1))));
    },
    dependencies: [d],
    styles: [
      `[_nghost-%COMP%] {
...
var _1 = (o, l) => l.title,
  b1 = () => ({ title: "Explore the Docs", link: "https://angular.dev" }),
  w1 = () => ({
    title: "Learn with Tutorials",
    link: "https://angular.dev/tutorials",
  }),
  x1 = () => ({ title: "CLI Docs", link: "https://angular.dev/tools/cli" }),
  O1 = () => ({
    title: "Angular Language Service",
    link: "https://angular.dev/tools/language-service",
  }),
    ...
    template: function (i, m) {
      i & 1 &&
        ...
        i & 2 &&
          ...
          _("Hello, ", m.title, ""),
          g(6),
          f(b(6, P1, c(1, b1), c(2, w1), c(3, x1), c(4, O1), c(5, k1))));
    },
    dependencies: [d],
    styles: [
      `[_nghost-%COMP%] {
...
var S1 = (o, l) => l.title,
  Z1 = () => ({ title: "Explore the Docs", link: "https://angular.dev" }),
  F1 = () => ({
    title: "Learn with Tutorials",
    link: "https://angular.dev/tutorials",
  }),
  E1 = () => ({ title: "CLI Docs", link: "https://angular.dev/tools/cli" }),
  H1 = () => ({
    title: "Angular Language Service",
    link: "https://angular.dev/tools/language-service",
  }),
    ...
    template: function (i, m) {
      i & 1 &&
        ...
        i & 2 &&
          ...
          _("Hello, ", m.title, ""),
          g(6),
          f(b(6, T1, c(1, Z1), c(2, F1), c(3, E1), c(4, H1), c(5, L1))));
    },
    dependencies: [d],
    styles: [
      `[_nghost-%COMP%] {
...
var D = [
  { path: "cliente", component: S },
  { path: "home", component: P },
  { path: "inventario", component: Z },
  { path: "login", component: y },
  { path: "negocio", component: F },
  { path: "recuperacion-cuenta", component: E },
  { path: "tendero", component: H },
];
var G = { providers: [L({ eventCoalescing: !0 }), z(D), I()] };
var I1 = { providers: [U()] },
  A = T(G, I1);
var U1 = () => V(k, A),
  w2 = U1;
