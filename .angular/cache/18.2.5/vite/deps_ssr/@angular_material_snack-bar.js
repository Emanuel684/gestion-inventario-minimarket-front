...
var FixedSizeVirtualScrollStrategy = class {
  ...
  constructor(itemSize, minBufferPx, maxBufferPx) {
    this._scrolledIndexChange = new import_rxjs3.Subject();
    this.scrolledIndexChange = this._scrolledIndexChange.pipe((0, import_operators2.distinctUntilChanged)());
    this._viewport = null;
...
var ScrollDispatcher = class _ScrollDispatcher {
  constructor(_ngZone, _platform, document2) {
    this._ngZone = _ngZone;
    this._platform = _platform;
    this._scrolled = new import_rxjs3.Subject();
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe((0, import_operators2.filter)((target) => {
  ...
  _addGlobalListener() {
    this._globalSubscription = this._ngZone.runOutsideAngular(() => {
      ...
      return (0, import_rxjs3.fromEvent)(window2.document, "scroll").subscribe(() => this._scrolled.next());
    });
  }
...
var CdkScrollable = class _CdkScrollable {
  constructor(elementRef, scrollDispatcher, ngZone, dir) {
    ...
    this._elementScrolled = new import_rxjs3.Observable((observer) => this.ngZone.runOutsideAngular(() => (0, import_rxjs3.fromEvent)(this.elementRef.nativeElement, "scroll").pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(observer)));
  }
  ngOnInit() {
...
var ViewportRuler = class _ViewportRuler {
  constructor(_platform, ngZone, document2) {
    this._platform = _platform;
    this._change = new import_rxjs3.Subject();
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  constructor(elementRef, _changeDetectorRef, ngZone, _scrollStrategy, dir, scrollDispatcher, viewportRuler, scrollable) {
    ...
    this._platform = inject(Platform);
    this._detachedSubject = new import_rxjs3.Subject();
    this._renderedRangeSubject = new import_rxjs3.Subject();
    this._orientation = "vertical";
    this.appendOnly = false;
    this.scrolledIndexChange = new import_rxjs3.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
    ...
    this._viewportChanges = import_rxjs3.Subscription.EMPTY;
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  constructor(_viewContainerRef, _template, _differs, _viewRepeater, _viewport, ngZone) {
    ...
    this.viewChange = new import_rxjs3.Subject();
    this._dataSourceChanges = new import_rxjs3.Subject();
    ...
    this._viewport.renderedRangeStream.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe((range2) => {
...
var CdkVirtualScrollableWindow = class _CdkVirtualScrollableWindow extends CdkVirtualScrollable {
  constructor(scrollDispatcher, ngZone, dir) {
    ...
    this._elementScrolled = new import_rxjs3.Observable((observer) => this.ngZone.runOutsideAngular(() => (0, import_rxjs3.fromEvent)(document, "scroll").pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(observer)));
  }
  measureBoundingClientRectWithScrollOffset(from) {
    return this.getElementRef().nativeElement.getBoundingClientRect()[from];
  }
...
var OverlayRef = class {
  constructor(_portalOutlet, _host, _pane, _config, _ngZone, _keyboardDispatcher, _document, _location, _outsideClickDispatcher, _animationsDisabled = false, _injector) {
    ...
    this._backdropClick = new import_rxjs4.Subject();
    this._attachments = new import_rxjs4.Subject();
    this._detachments = new import_rxjs4.Subject();
    this._locationChanges = import_rxjs4.Subscription.EMPTY;
    this._backdropClickHandler = (event) => this._backdropClick.next(event);
    this._backdropTransitionendHandler = (event) => {
      this._disposeBackdrop(event.target);
    };
    this._keydownEvents = new import_rxjs4.Subject();
    this._outsidePointerEvents = new import_rxjs4.Subject();
    this._renders = new import_rxjs4.Subject();
  ...
  _detachContentWhenEmpty() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._renders.pipe((0, import_operators3.takeUntil)((0, import_rxjs4.merge)(this._attachments, this._detachments))).subscribe(() => {
...
var FlexibleConnectedPositionStrategy = class {
  ...
  constructor(connectedTo, _viewportRuler, _document, _platform, _overlayContainer) {
    ...
    this._positionChanges = new import_rxjs4.Subject();
    this._resizeSubscription = import_rxjs4.Subscription.EMPTY;
    this._offsetX = 0;
    this._offsetY = 0;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  constructor(_overlay, templateRef, viewContainerRef, scrollStrategyFactory, _dir) {
    ...
    this._dir = _dir;
    this._backdropSubscription = import_rxjs4.Subscription.EMPTY;
    this._attachSubscription = import_rxjs4.Subscription.EMPTY;
    this._detachSubscription = import_rxjs4.Subscription.EMPTY;
    this._positionSubscription = import_rxjs4.Subscription.EMPTY;
...
var MatSnackBarRef = class {
  constructor(containerInstance, _overlayRef) {
    ...
    this._afterDismissed = new import_rxjs5.Subject();
    this._afterOpened = new import_rxjs5.Subject();
    this._onAction = new import_rxjs5.Subject();
...
var MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  constructor(_ngZone, _elementRef, _changeDetectorRef, _platform, snackBarConfig) {
    ...
    this._onAnnounce = new import_rxjs5.Subject();
    this._onExit = new import_rxjs5.Subject();
    this._onEnter = new import_rxjs5.Subject();
...
var MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    ...
    this._breakpointObserver.observe(Breakpoints.HandsetPortrait).pipe((0, import_operators4.takeUntil)(overlayRef.detachments())).subscribe((state2) => {
