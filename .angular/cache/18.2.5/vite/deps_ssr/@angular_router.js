...
import { Title } from "./chunk-XJXT7ETF.js";
import {
  DOCUMENT,
...
import { __spreadProps, __spreadValues, __toESM } from "./chunk-NQ4HTGF6.js";
  ...
  constructor(
    ...
    this.title =
      this.dataSubject?.pipe(
        (0, import_operators.map)((d) => d[RouteTitleKey]),
    ...
    return (0, import_rxjs.combineLatest)(
      obs.map((o) =>
        o.pipe(
          ...
          (0, import_operators.startWith)(INITIAL_VALUE),
        ),
      ),
    ).pipe(
...
function runCanActivate(futureRSS, futureARS, injector) {
  ...
  return (0, import_rxjs.of)(canActivateObservables).pipe(
...
function runCanActivateChild(futureRSS, path, injector) {
  ...
  return (0, import_rxjs.of)(canActivateChildGuardsMapped).pipe(
    prioritizedGuardValue(),
  );
}
function runCanDeactivate(component, currARS, currRSS, futureRSS, injector) {
  ...
  return (0, import_rxjs.of)(canDeactivateObservables).pipe(
    prioritizedGuardValue(),
  );
}
...
function matchWithChecks(
  ...
  return runCanMatchGuards(injector, route, segments, urlSerializer).pipe(
    (0, import_operators.map)((v) =>
      v === true ? result : __spreadValues({}, noMatch),
    ),
  );
}
...
var Recognizer = class {
  ...
  recognize() {
    ...
    return this.match(rootSegmentGroup).pipe(
      (0, import_operators.map)(({ children, rootSnapshot }) => {
  ...
  processChildren(injector, config, segmentGroup, parentRoute) {
    ...
    return (0, import_rxjs.from)(childOutlets).pipe(
      (0, import_operators.concatMap)((childOutlet) => {
      ...
      (0, import_operators.defaultIfEmpty)(null),
      (0, import_operators.last)(),
      (0, import_operators.mergeMap)((children) => {
  ...
  processSegment(
    ...
    return (0, import_rxjs.from)(routes).pipe(
      (0, import_operators.concatMap)((r) => {
...
This is currently a dev mode only error but will become a call stack size exceeded error in production in a future major version.`,
    ...
    return this.applyRedirects.lineralizeSegments(route, newTree).pipe(
      (0, import_operators.mergeMap)((newSegments) => {
        return this.processSegment(
          injector,
          routes,
          segmentGroup,
    ...
    return matchResult.pipe(
      (0, import_operators.switchMap)((result) => {
        ...
        return this.getChildConfig(injector, route, segments).pipe(
          (0, import_operators.switchMap)(({ routes: childConfig }) => {
  ...
  getChildConfig(injector, route, segments) {
    ...
    if (route.loadChildren) {
      ...
      return runCanLoadGuards(
        ...
        (0, import_operators.mergeMap)((shouldLoadResult) => {
          if (shouldLoadResult) {
            return this.configLoader.loadChildren(injector, route).pipe(
              (0, import_operators.tap)((cfg) => {
...
function switchTap(next) {
  return (0, import_operators.switchMap)((v) => {
    ...
    if (nextResult) {
      return (0, import_rxjs.from)(nextResult).pipe(
        (0, import_operators.map)(() => v),
      );
    }
...
var RouterConfigLoader = class _RouterConfigLoader {
  ...
  loadComponent(route) {
    ...
    const loadRunner = wrapIntoObservable(route.loadComponent()).pipe(
      (0, import_operators.map)(maybeUnwrapDefaultExport),
      (0, import_operators.tap)((component) => {
    ...
    const loader = new import_rxjs.ConnectableObservable(
      loadRunner,
      () => new import_rxjs.Subject(),
    ).pipe((0, import_operators.refCount)());
            ...
            if (t.guards.canActivateChecks.length) {
              return (0, import_rxjs.of)(t).pipe(
                ...
                (0, import_operators.switchMap)((t2) => {
                  ...
                  return (0, import_rxjs.of)(t2).pipe(
                    resolveData(
                      this.paramsInheritanceStrategy,
                      this.environmentInjector,
                    ),
              ...
              if (
                ...
                loaders.push(
                  this.configLoader.loadComponent(route.routeConfig).pipe(
                    (0, import_operators.tap)((loadedComponent) => {
...
function afterNextNavigation(router, action) {
  router.events
    .pipe(
      ...
      (0, import_operators.filter)(
        (result) => result !== NavigationResult.REDIRECTING,
      ),
      (0, import_operators.take)(1),
    )
    .subscribe(() => {
...
var RouterLinkActive = class _RouterLinkActive {
  ...
  /** @nodoc */
  ngAfterContentInit() {
    (0, import_rxjs.of)(this.links.changes, (0, import_rxjs.of)(null))
      .pipe((0, import_operators.mergeAll)())
      .subscribe((_) => {
        this.update();
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0, import_rxjs.from)(allLinkChanges)
      .pipe((0, import_operators.mergeAll)())
      .subscribe((link) => {
  ...
  setUpPreloading() {
    this.subscription = this.router.events
      .pipe(
        ...
        (0, import_operators.concatMap)(() => this.preload()),
      )
      .subscribe(() => {});
  }
  preload() {
  ...
  preloadConfig(injector, route) {
    return this.preloadingStrategy.preload(route, () => {
      ...
      const recursiveLoadChildren$ = loadedChildren$.pipe(
        (0, import_operators.mergeMap)((config) => {
          if (config === null) {
            return (0, import_rxjs.of)(void 0);
          }
