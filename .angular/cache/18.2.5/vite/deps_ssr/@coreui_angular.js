...
var Typeahead = class {
  constructor(initialItems, config) {
    this._letterKeyStream = new import_rxjs5.Subject();
    this._items = [];
    this._selectedItemIndex = -1;
    this._pressedLetters = [];
    this._selectedItem = new import_rxjs5.Subject();
...
var ListKeyManager = class {
  constructor(_items, injector) {
    ...
    this._wrap = false;
    this._typeaheadSubscription = import_rxjs5.Subscription.EMPTY;
    this._vertical = true;
    ...
    this.tabOut = new import_rxjs5.Subject();
    this.change = new import_rxjs5.Subject();
...
var InputModalityDetector = class _InputModalityDetector {
  ...
  constructor(_platform, ngZone, document2, options) {
    ...
    this._modality = new import_rxjs5.BehaviorSubject(null);
    this._lastTouchMs = 0;
...
var FocusMonitor = class _FocusMonitor {
  constructor(_ngZone, _platform, _inputModalityDetector, document2, options) {
    ...
    this._stopInputModalityDetector = new import_rxjs5.Subject();
  ...
  constructor() {
    ...
    this.disabledEffect = effect(() => {
      if (!this.#disabled()) {
        ...
        (0, import_rxjs6.merge)(focusIn$, click$).pipe((0, import_operators5.filter)(($event) => !this.#disabled()), (0, import_operators5.tap)(($event) => {
          this.#tabsService.activeItemKey.set(untracked(this.itemKey));
        }), (0, import_rxjs6.takeWhile)(() => !this.#disabled()), takeUntilDestroyed(this.#destroyRef)).subscribe();
      }
    }, {
      allowSignalWrites: true
    });
