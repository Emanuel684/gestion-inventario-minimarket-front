...
var ShadowOnScrollDirective = class _ShadowOnScrollDirective {
  ...
  set cShadowOnScroll(value) {
    ...
    if (value) {
      ...
      this.#observable = (0, import_rxjs2.fromEvent)(this.#document, "scroll").pipe(takeUntilDestroyed(this.#destroyRef)).subscribe((scrolled) => {
...
var BackdropService = class _BackdropService {
  constructor() {
    this.#backdropClick = new import_rxjs2.Subject();
...
var BreadcrumbRouterService = class _BreadcrumbRouterService {
  ...
  constructor(router, route) {
    ...
    this.route = route;
    this.outlet = "primary";
    this.#breadcrumbsBehaviorSubject = new import_rxjs2.BehaviorSubject(new Array());
...
var IntersectionService = class _IntersectionService {
  constructor() {
    ...
    this.#intersecting = new import_rxjs2.BehaviorSubject({
...
var LocalStorageService = class _LocalStorageService {
  constructor() {
    this.platformId = inject(PLATFORM_ID);
    this.document = inject(DOCUMENT);
    this.#data$ = new import_rxjs2.BehaviorSubject(null);
...
var CarouselComponent = class _CarouselComponent {
  ...
  swipeSubscribe(subscribe = true) {
    if (this.touch && subscribe) {
      ...
      this.swipeSubscription = touchStart$.pipe((0, import_operators2.zipWith)(touchEnd$.pipe((0, import_operators2.withLatestFrom)(touchMove$))), takeUntilDestroyed(this.#destroyRef)).subscribe(([touchstart, [touchend, touchmove]]) => {
...
var DropdownMenuDirective = class _DropdownMenuDirective {
  ...
  ngOnInit() {
    this.#dropdownService.dropdownState$.pipe((0, import_operators2.tap)((state2) => {
...
var OffcanvasComponent = class _OffcanvasComponent {
  ...
  layoutChangeSubscribe(subscribe = true) {
    if (subscribe) {
      ...
      this.#layoutChangeSubscription = layoutChanges.pipe((0, import_operators2.filter)((breakpointState) => !breakpointState.matches), takeUntilDestroyed(this.#destroyRef)).subscribe((breakpointState) => {
...
var TabDirective = class _TabDirective {
  constructor() {
    ...
    this.disabledEffect = effect(() => {
      if (!this.#disabled()) {
        const click$ = (0, import_rxjs2.fromEvent)(this.#elementRef.nativeElement, "click");
        const focusIn$ = (0, import_rxjs2.fromEvent)(this.#elementRef.nativeElement, "focusin");
        (0, import_rxjs2.merge)(focusIn$, click$).pipe((0, import_operators2.filter)(($event) => !this.#disabled()), (0, import_operators2.tap)(($event) => {
          this.#tabsService.activeItemKey.set(untracked(this.itemKey));
        }), (0, import_rxjs2.takeWhile)(() => !this.#disabled()), takeUntilDestroyed(this.#destroyRef)).subscribe();
      }
    }, {
      allowSignalWrites: true
    });
...
var TabsListComponent = class _TabsListComponent {
  constructor() {
    ...
    this.tabsEffect = effect(() => {
      ...
      this.#focusKeyManager.change.pipe((0, import_operators2.tap)((value) => {
